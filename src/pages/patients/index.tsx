...
export function PatientListPage(props: PatientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPatients({
        relations: ['user', 'lab_result.count', 'medical_record.count', 'prescription.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['insurance_details.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'insurance_details', header: 'Insurance Details', accessorKey: 'insurance_details' },
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('lab_result', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'lab_result',
          header: 'Lab Result',
          accessorKey: 'lab_result',
          cell: ({ row: { original: record } }: any) => record?._count?.lab_result,
        }
      : null,
    ...
    hasAccess('prescription', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.prescription,
        }
      : null,
