...
import { LabResultListPage } from 'pages/lab-results';
import { MedicalRecordListPage } from 'pages/medical-records';
import { PrescriptionListPage } from 'pages/prescriptions';
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Insurance Details" text={data?.insurance_details} />
