...
import { createLabResult } from 'apiSdk/lab-results';
...
function LabResultCreatePage() {
  ...
  const formik = useFormik<LabResultInterface>({
    initialValues: {
      ...
      lab_technician_id: (router.query.lab_technician_id as string) ?? null,
    },
