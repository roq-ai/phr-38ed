...
import { getLabResultById } from 'apiSdk/lab-results';
import { LabResultInterface } from 'interfaces/lab-result';

function LabResultViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('lab_result', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/lab-results/edit/${id}`} passHref legacyBehavior>
                    <Button
                  ...
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/patients/view/${data?.patient?.id}`}>
                        {data?.patient?.insurance_details}
                      </Link>
                    }
                  />
                )}
